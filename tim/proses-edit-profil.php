...
<?php
        ...
        if(isset($_POST['edit-tim']))
        {
          ...
          $jml_pemain            = $_POST['jml_pemain'];
            ...
            $update = mysqli_query($koneksi, "UPDATE tim SET nama_tim='$nama_tim', alamat_tim='$alamat_tim', penanggung_jawab='$penanggung_jawab', email_tim='$email_tim', tlp_tim ='$tlp_tim', jml_pemain ='$jml_pemain' WHERE id_tim='$id_tim'") or die (mysqli_error());

          if($update)
          {
            $sql1 = mysqli_query($koneksi, "SELECT * FROM tim WHERE id_tim='$id_tim'");
