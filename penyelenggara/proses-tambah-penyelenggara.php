...
include "../koneksi.php";
				if(isset($_POST['add']))
				{
					...
					{
						$insert = mysqli_query($koneksi, "INSERT INTO penyelenggara(nama_penyelenggara, nama_lomba, lokasi_lomba, waktu_awal_lomba,waktu_akhir_lomba,id_kategori, email_penyelenggara, tlp_penyelenggara, username_penyelenggara, password_penyelenggara, pembayaran_penyelenggara, id_level, status_penyelenggara,logo) VALUES('$nama_penyelenggara', '$nama_lomba', '$lokasi_lomba', '$waktu_awal_lomba', '$waktu_akhir_lomba', '$id_kategori', '$email_penyelenggara', '$tlp_penyelenggara', '$username_penyelenggara', '$password_penyelenggara', '$fotobaru', '$id_level', '$status_penyelenggara','$logo')") or die(mysqli_error($koneksi));
							if($insert)
							{
