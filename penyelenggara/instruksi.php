  ...
  <!-- Facebook and Twitter integration -->
	...
	<div id="fh5co-main">
		...
		<div class="container">
			<div class="row">
				<div class="col-md-8">
					<h2>Alur Pendaftaran peserta</h2>
					<p>1. Llalallallalalall</p>
					<p>2. Llalallallalgxbxbfalall</p>
					<p>3. Llalallalfsdnkvbndnvndnvsdnlalalall</p>

					<h2>Alur Pendaftaran Penyelenggara</h2>
					<p>1. Llalallallalalall</p>
					<p>2. HhhshdhsLlalallallalalall</p>
					<p>3. Llalallalldvnnxnnxvnnvnnvdvalalall</p>
