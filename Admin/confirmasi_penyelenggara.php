      ...
      <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
        ...
        <div class="collapse navbar-collapse navbar-ex1-collapse">
          <ul class="nav navbar-nav side-nav">
            <li><a href="index.php"><i class="fa fa-dashboard"></i> Data Penyelenggara</a></li>
            <li class="active"><a href="confirmasi_penyelenggara.php"><i class="fa fa-bar-chart-o"></i> Confirmasi Penyelenggara</a></li>
      ...
      <?php
          ...
          while($row = mysqli_fetch_assoc($sql)){
            ...
            <tr>
              ...
              <td style="text-align: center">'.$row['pembayaran_penyelenggara'].'</td>
